      ...
      <div className="w-full max-w-md">
        <div className="rounded-2xl border bg-card p-8 shadow-sm">
          ...
          <div className="mt-4 text-center text-sm">
            <Link to={`/register?role=${role}`} className="text-primary hover:underline">Crea un account</Link>
            <span className="mx-2 text-muted-foreground">·</span>
            <button className="text-muted-foreground hover:text-foreground">Password dimenticata?</button>
          </div>
        </div>
      </div>
    </div>
